...
public class SearchEmployee extends JFrame {
	...
	public SearchEmployee() {
		...
		JLabel lblReturnBook = new JLabel("Search Employee");
		lblReturnBook.setForeground(Color.GRAY);
		lblReturnBook.setFont(new Font("Tahoma", Font.PLAIN, 18));
		
		JLabel lblBookCallno = new JLabel("Employee ID");
		...
		btnReturnBook.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				String edetails=textField.getText();
	
					ViewSearchedEmployee.main(edetails);
					frame.dispose();
